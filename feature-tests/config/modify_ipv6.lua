...
Feature.flowEntries = function(openflowVersion, flowData, outPort)
    table.insert(flowData.flows, string.format("table=0, ipv6, actions=set_field:%s->ipv6_src, set_field:%s->ipv6_dst, output:%s", conf.new_SRC_IP6, conf.new_DST_IP6, outPort))
  end
