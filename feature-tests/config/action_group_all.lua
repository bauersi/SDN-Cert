...
Feature.flowEntries = function(openflowVersion, flowData, outPort1, outPort2)
    table.insert(flowData.groups, string.format("group_id=1, type=all, bucket=mod_nw_src=%s,output:%s, bucket=mod_nw_dst=%s,output:%s", conf.new_SRC_IP4, outPort1, conf.new_DST_IP4, outPort2))
